...
SinglyLinkedListNode* delete_node(SinglyLinkedListNode* llist, int position)
{
  if (position == 0)
  {
  ...
  {
    SinglyLinkedListNode* previous_node = llist;
    SinglyLinkedListNode* current_node  = llist->next;
...
int main()
{
  ...
  SinglyLinkedListNode* llist1 = delete_node(llist->head, position);
