...
void insert_node_into_singly_linked_list(SinglyLinkedList** sinlgy_linked_list, int node_data);
void print_singly_linked_list(SinglyLinkedListNode* node, char* sep);
void free_singly_linked_list(SinglyLinkedListNode* node);

void reverse_print(SinglyLinkedListNode* llist)
{
  if (llist != NULL)
  {
    reverse_print(llist->next);
    printf("%d\n", llist->data);
  }
}
