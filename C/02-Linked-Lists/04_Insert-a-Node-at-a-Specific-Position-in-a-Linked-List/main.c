...
SinglyLinkedListNode* insert_node_at_position(SinglyLinkedListNode* llist, int data, int position)
{
  SinglyLinkedListNode* node = NULL;
  SinglyLinkedListNode* ptr_iterator = llist;
...
int main()
{
  ...
  SinglyLinkedListNode* llist_head = insert_node_at_position(llist->head, data, position);
